odoo.define('reports_designer.FieldDomainParam', function(require){
	"use strict";
...
var DomainSelectorDialog = require('reports_designer.DomainSelectorDialogParam');
...
var FieldDomainParam = AbstractField.extend({
    ...
    isValid: function () {
        ...
        var params_all =  ("" + this.recordData.reports_designer_param_content).split(';');
        var i_split = ''
    ...
    _render: function () {
        ...
        this.recordData.reports_designer_param_content
        var params = this.recordData.reports_designer_param_content;
